            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className='rounded-md'>
                    ...
                    <div
                        ...
                        className="w-full p-4 border-2 border-dashed border-zinc-300 rounded cursor-pointer flex items-center justify-center min-h-72"
                    >
                ...
                <button
                    type="submit"
                    className="w-full flex justify-center py-1 px-2 sm:py-2 sm:px-4 border border-transparent rounded-md text-black/80 bg-yellow-600 sm:font-semibold hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                >
                    Upload
                </button>
            </form>
            ...
            <div className="flex justify-between items-center col-span-2">
                ...
                <div className='gap-4 sm:w-60 flex items-center justify-center'>
                    <button
                        ...
                        disabled={!isSaved}
                        className="flex items-center justify-center gap-1.5 px-2 py-1 sm:px-4 sm:py-2 text-sm sm:text-base w-full bg-green-600 text-black/80 rounded sm:font-semibold"
                    >
                        Complete
