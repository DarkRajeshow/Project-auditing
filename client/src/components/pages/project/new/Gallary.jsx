            ...
            <form onSubmit={handleSubmit} className="py-2 sm:py-8 sm:grid grid-cols-2 gap-5 " >
                ...
                <div className='rounded-md mt-4 mb-6'>
                    ...
                    <div
                        ...
                        className="w-full p-4 border-2 border-dashed border-zinc-300 rounded mt-1 cursor-pointer flex items-center justify-center h-72"
                    >
                ...
                <div className="flex justify-between items-center col-span-2">
                    ...
                    <div className='flex items-center justify-center gap-4'>
                        <button
                            type="submit"
                            className={`px-4 font-semibold py-1.5 bg-blue-300 rounded-md flex gap-2 items-center justify-center `}
                        >
